...
<p className="text-lg font-semibold text-primary-600">{formatCurrency(rental.daily_rate)}/day</p>
                    </div>
                    <div>
...
<p className="text-2xl font-bold text-green-600">{formatCurrency(rental.total_amount)}</p>
                    </div>
                  </div>
