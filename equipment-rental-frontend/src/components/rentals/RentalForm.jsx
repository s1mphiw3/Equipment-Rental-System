        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-primary-600">
              {formatCurrency(equipment.daily_rate)} <span className="text-sm font-normal text-gray-500">per day</span>
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="ml-2 font-medium">{formatCurrency(equipment.daily_rate)}</span>

            </div>
            <div className="col-span-2 border-t border-blue-200 pt-2">
              <span className="text-blue-900 font-semibold">Total Cost:</span>
              <span className="ml-2 text-lg font-bold text-blue-900">{formatCurrency(totalCost)}</span>
